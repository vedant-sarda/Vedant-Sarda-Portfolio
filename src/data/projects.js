...
const createProjectPath = (path) => `${BASE_PATH}/${path}`;
...
export const projects = [
  {
    ...
    category: "fullstack",
    image: createProjectPath("atorix.png"),
    icon: createProjectPath("atorix-favicon.png"),
    screenshots: [createProjectPath("atorix-1.png"), createProjectPath("atorix-2.png")],
  ...
  },
  {
    ...
    category: "fullstack",
    image: createProjectPath("erp.png"),
    screenshots: [createProjectPath("erp-1.png"), createProjectPath("erp-2.png")],
  ...
  },
  {
    ...
    category: "fullstack",
    image: createProjectPath("wildrydes.png"),
    screenshots: [createProjectPath("wildrydes-1.png")],
  ...
  },
  {
    ...
    category: "fullstack",
    image: createProjectPath("portfolio_website.png"),
  ...
  },
  {
    ...
    image: createProjectPath("salesforce.jpg"),
